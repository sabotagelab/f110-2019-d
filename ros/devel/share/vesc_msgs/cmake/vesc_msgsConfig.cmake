...
if(NOT "/home/nathan/f1-autonomous/ros/devel/include " STREQUAL " ")
  set(vesc_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/nathan/f1-autonomous/ros/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vesc_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nathan/f1-autonomous/ros/src/vesc/vesc_msgs/${idir}'.  ${_report}")
    endif()
